...
// Delete control for a document session (Business Case / Editorial Brief).
// Admin-only — render only for admins. Mirrors DeleteInterviewButton.
  ...
  return (
    <>
      ...
      <Modal
        ...
        title={`Delete "${title}"?`}
        description="This permanently deletes this document and its output. This can't be undone."
        confirmLabel="Delete"
