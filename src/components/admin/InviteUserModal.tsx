...
const defaultForm = { email: '', role: 'user', tokenLimit: '100000' }
          ...
          {inviteUrl ? (
            ...
            <div className="flex flex-col gap-5">
              <div className="p-4 bg-emerald-50 border border-emerald-200">
                <p className="text-sm font-medium text-emerald-800 mb-1">Invite created</p>
                <p className="text-xs text-emerald-700 leading-relaxed">
                  Copy the link below and send it to <span className="font-medium">{form.email}</span>.
