...
// Delete control for an interview (research session). Admin-only — render it
// only for admins. Two looks:
...
export default function DeleteInterviewButton({
  ...
  const title = interviewTitle || 'this interview'
  ...
  return (
    <>
      ...
      <Modal
        ...
        title={`Delete "${title}"?`}
        description="This permanently deletes the interview, including its research, questions, and chat history. This can't be undone."
        confirmLabel="Delete"
