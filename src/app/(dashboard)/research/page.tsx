...
import { Sparkles, ClipboardList, MessageSquare, ArrowRight, Info } from 'lucide-react'
    ...
    <div className="flex flex-col lg:flex-row h-full min-h-0">
      ...
      <div className="flex-1 flex flex-col items-center justify-center bg-[#f0efec] p-8 order-2 min-h-[280px]">
        <div className="w-full max-w-sm">
          ...
          <div className="mt-8 flex items-start gap-2.5 rounded-lg border border-blue-200 bg-blue-50 px-4 py-3">
            <Info size={15} className="mt-0.5 flex-shrink-0 text-blue-500" />
            <p className="text-[11px] text-blue-800 leading-relaxed">
              This content is generated by AI. Please review and verify the details
